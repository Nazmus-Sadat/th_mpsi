...
public:
  ...
  */
  ...
  void deserialize_manually_at_position(std::istream& inputstream, int position) {
	//inputstream.seekg(position * 8192 * 8);
    poly_obj().deserialize_manually_at_position(inputstream, position);
  }
